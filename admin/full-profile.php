...
<?php 
		 $ret= mysql_query("SELECT * FROM registration where id = '".$_GET['id']."'");
			...
			<tr>
			  <td colspan="2"  class="heading" style="color: red;">House Related Info &raquo; </td>
  </tr>
			<tr>
			  <td colspan="2"  class="font1"><table width="100%" border="0">
                <tr>
                  <td width="32%" valign="top" class="heading">Area  : </td>
                  
                      <td class="comb-value1"><span class="comb-value"><?php echo $row['area'];?></span></td>
                    </tr>
                  <tr>
                  <td width="22%" valign="top" class="heading">Block : </td>
                  
                      <td class="comb-value1"><span class="comb-value"><?php echo $row['block'];?></span></td>
                    </tr>
                  
                     <tr>
                    <td width="12%" valign="top" class="heading">Criminal Record: </td>
                      <td class="comb-value1"><?php if($row['crime']==0)
{
  echo "Without Criminal Record";
}
else
{
  echo "With Criminal Record";
}
                      ;?></td>
                    </tr>
                    <tr>
                    <td width="12%" valign="top" class="heading">Registration Date: </td>
                      <td class="comb-value1"><?php echo $row['regdate'];?></td>
                    </tr>
...
<tr>
<td width="12%" valign="top" class="heading">Application Type: </td>
<td class="comb-value1"><?php echo $row['apptype'];?></td>
</tr>

<tr>
<td width="12%" valign="top" class="heading">ID no: </td>
...
<tr>
<td width="12%" valign="top" class="heading">Marriage Status: </td>
<td class="comb-value1"><?php echo $row['marriage'];?></td>
</tr>
